...
var signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, email, password, confirmPassword) {
    var res;
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // Extends map bounds to include current locations
...
var stripe = Stripe('pk_test_51HU87CJKBVX5ZxvepP0if62yKEzFKRGr3Sl80HmsTaaQoLbNRYlSx4lIW3uwZGgnHSBmCvLlXXlC9Mr5gzXV1kwF001NTfEQ0N');
