...
exports.getMonthlyPlan = catchAsync(async (req, res, next) => {
    ...
    const plan = await Tour.aggregate([
        {
            // created single documents of each dates
            $unwind: '$startDates'
        },
        {
            $match: {
...
exports.waitForIndex = catchAsync(async (req,res,next) =>{
    Tour.on('index', err => err ? next(new AppError('index not build')): next() )
})